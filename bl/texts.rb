...
HOSPITALS = ["בית חולים איכילוב", "בית חולים בילינסון", "בית חולים תל השומר", "בית חולים אסף הרופא", "בית חולים רמב\"ם", "בית חולים ברזילי", "בית חולים לניאדו", "בית חולים הלל יפה", "בית חולים סורוקה", "בית חולים יוספטל", "בית חולים זיו", "בית חולים פוריה"]
...
TREATMENTS_LIST.each { |treatment| TEXTS[treatment] = {he: treatment, en: treatment} }
